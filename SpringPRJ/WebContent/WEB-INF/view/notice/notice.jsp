								...
								<div>
									<div class="container" style="min-height: 460px;">
										<div class="row">
											...
											<!-- 작성자 -->
											<div class="col-md-3 lg-content-st"><%=nList.get(i).getReg_id()%></div>
								...
								<nav class="blog-pagination justify-content-center d-flex">
									<ul class="pagination">
										...
										<li class="page-item  active"><a
											href="/notice/notice.do?pgNum=<%=a%>" class="page-link"><%=a%></a></li>
										<%
											} else {
										%>
										...
										%>
										<li class="page-item"><a
											href="/notice/notice.do?pgNum=<%=paging.getEndPage() + 1%>"
