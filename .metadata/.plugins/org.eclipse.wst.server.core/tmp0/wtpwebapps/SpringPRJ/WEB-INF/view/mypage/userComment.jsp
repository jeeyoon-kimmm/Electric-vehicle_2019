...
<%
	...
	List<B_CommentDTO> bList = (List<B_CommentDTO>) request.getAttribute("bList");
										...
										<div class="container" style="min-height: 460px;">
											<div class="row">
												...
												<div class="col-md-6 table-title"
													style="color: #F6D91D; font-weight: bolder;">내용</div>
												...
												<div class="col-md-12" style="height: 20em">
													<div class="inner_cell">
														<span class="txt_public">댓글이 없습니다.</span>
													</div>
												</div>
												<%
													} else {
												...
												<div class="col-md-6 lg-content-st" style="color: cornsilk;">
													<span class="txt_public"> <a
														...
														href="/board/BoardDetail.do?seq=<%=bList.get(i).getNo_seq()%>">
												...
												<!-- 작성자 -->
												<div class="col-md-3 lg-content-st" style="color: cornsilk;"><%=bList.get(i).getUser_id()%></div>
