									...
									<div class="widget personal-info">
										...
										<div class="container" style="min-height: 460px;">
											<div class="row">
												...
												<div class="col-md-6 table-title" style="color: #F6D91D;font-weight: bolder;">제목</div>
												<div class="col-md-3 table-title" style="color: #F6D91D;font-weight: bolder;">작성자</div>
												<div class="col-md-3 table-title" style="color: #F6D91D;font-weight: bolder;">등록일</div>
												...
												<div class="col-md-6 lg-content-st" style="color: cornsilk;">
													<span class="txt_public"> <a
														...
														href="/notice/NoticeDetail.do?seq=<%=nList.get(i).getSeq()%>&pgNum=<%=paging.getPage()%>">
															<%=nList.get(i).getTitle().replaceAll("<", "&lt;").replaceAll(">", "&gt;")%>
													</a>
													</span>
												</div>

												<!-- 작성자 -->
												<div class="col-md-3 lg-content-st" style="color: cornsilk;"><%=nList.get(i).getReg_id()%></div>
											...
											<nav class="blog-pagination justify-content-center d-flex">
												<ul class="pagination">
													...
													<li class="page-item  active"><a
														href="/manager/noticeList.do?pgNum=<%=a%>" class="page-link"><%=a%></a></li>
													<%
														} else {
													%>
													...
													%>
													<li class="page-item"><a
														href="/manager/noticeList.do?pgNum=<%=paging.getEndPage() + 1%>"
