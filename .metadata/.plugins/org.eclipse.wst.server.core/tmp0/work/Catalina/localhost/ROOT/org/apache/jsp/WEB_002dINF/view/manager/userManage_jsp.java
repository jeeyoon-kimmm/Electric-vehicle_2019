 ...
 * Generated at: 2019-12-08 20:45:15 UTC
...
public final class userManage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	List<UserDTO> bList = (List<UserDTO>) request.getAttribute("bList");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<h3 class=\"widget-header user\" style=\"text-color: #848484;\">회원관리</h3>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"container\" style=\"min-height: 460px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-6 table-title\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"color: #F6D91D; font-weight: bolder;\">사용자 이름</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-3 table-title\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"color: #F6D91D; font-weight: bolder;\">아이디</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-3 table-title\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"color: #F6D91D; font-weight: bolder;\">회원 관리</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"txt_public\">사용자가 없습니다.</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"txt_public\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print(bList.get(i).getUserName());
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.print(bList.get(i).getUserId());
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<!-- 등록일 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-3 lg-content-st\" style=\"color: cornsilk;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<a  href=\"/manager/deleteUser.do?userid=");
      out.print(bList.get(i).getUserId());
      out.write("\"><button>회원 탈퇴</button></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
